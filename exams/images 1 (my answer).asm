## PRENDE LUCES CUANDO SE PRESIONAN LLAVES. PERO PRENDE LUCES CONTRARIAS. 

- DETALLES: AL PRESIONARSE SOLO LA PRIMER LUZ MANDA BUENOS DIAS Y AL NO PRESIONARSE NINGUNA MANDA ADIOS.
